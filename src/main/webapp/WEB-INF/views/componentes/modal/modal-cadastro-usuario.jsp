...
<div class="modal fade" id="modal-cadastro-usuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="${path}/usuarios/cadastro" method="post" acceptcharset="UTF-8">
          ...
          <legend>Informações Gerais:</legend>
            ...
            <div class="row">                 
              <div class="col-4">
                <div class="form-group">
                    <label>CPF:</label>
                    <input type="text" class="form-control" id="cpf" name="cpf" onchange="if(!validarCPF(this.value)){alert('CPF inválido!'); this.value='';}" required>
                </div>
              </div>  
              <div class="col-4">
                <div class="form-group">
        ...
        <div class="modal-footer">
          <button type="su" class="btn btn-success">Enviar</button>

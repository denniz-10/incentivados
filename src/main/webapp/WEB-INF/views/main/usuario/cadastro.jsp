					...
					<div class="col-12">
						<form action="${path}/usuarios/cadastro" method="post" acceptcharset="UTF-8">
							...
							<hr class="bg-primary">
                  			...
                  			<a href="${path}/login" class="btn btn-info float-right">Login <i class="fas fa-sign-in-alt"></i></a>
                  			<a href="${path}/login?redirect=painel/pedidos/Leroy Merlin/cadastro" class="btn btn-info float-right">Pedidos Leroy</a>
						</form>											
					</div>
				</div>
			</div>
